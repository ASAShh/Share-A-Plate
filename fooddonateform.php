...
if(isset($_POST['submit']))
{
    ...
    $query="insert into food_donations(email,food,type,category,phoneno,location,address,name,quantity) values('$emailid','$foodname','$meal','$category','$phoneno','$area','$address','$name','$quantity')";
...
<head>
    ...
    <title>Share<b style="color: #06C167; font-size: 50px;">A</b>Plate</title>
...
<body style="    background-color: #06C167;">
    ...
    <div class="logo">Share<b style="color: #06C167; font-size: 50px;">A</b>Plate</div>
...
<select id="area" name="area" style="padding:10px;">
<option value="Domlur">Domlur</option>
                    <option value="Indiranagar">Indiranagar</option>
                    <option value="Rajajinagar">Rajajinagar</option>
                    <option value="Malleswaram">Malleswaram</option>                          <option value="Sadashivanagar">Sadashivanagar</option>
                    ...
                    <option value="Marathalli">Marathalli</option>                        <option value="Whitefield">Whitefield</option>
